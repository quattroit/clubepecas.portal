...
function PartRequestForm({
  ...
  const {
    ...
    resolver: zodResolver(partRequestFormSchema),
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-2">
          <Label htmlFor="pr-vehicle-brand">Marca</Label>
          <select
            id="pr-vehicle-brand"
            className={selectClassName}
        ...
        <div className="flex flex-col gap-2">
          <Label htmlFor="pr-vehicle-model">Modelo</Label>
          <select
            id="pr-vehicle-model"
            className={selectClassName}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-2">
          <Label htmlFor="pr-manufacturing-year">Ano fabricação</Label>
          <select
